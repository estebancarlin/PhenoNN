...
Usage
-----
    python -m phenon.dataset_creation.add_soil_moisture_proxy \\
...
from phenon.training.config import FEATURES_FNAME
...
def _process_year(year: int, era5_dir: Path, out_dir: Path,
                  complevel: int) -> None:
    ...
    to_netcdf_subprocess(ds, out_dir / FEATURES_FNAME.format(year=year),
