...
class ModelUtils:
    ...
    def get_parameter_number(model, logger=None):
        ...
        logger : phenonn.utils.logger.Logger, optional
            phenonn.utils.logger.Logger instance for output, by default None
    ...
    def load_training_checkpoint(
        ...
        logger : phenonn.utils.logger.Logger, optional
            phenonn.utils.logger.Logger instance for output
    ...
    def save_training_checkpoint(
        ...
        paths : EasyDict
            Directory paths
        logger : phenonn.utils.logger.Logger
            phenonn.utils.logger.Logger instance
        checkpoint_type : str
