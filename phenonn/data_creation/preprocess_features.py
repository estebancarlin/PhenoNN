...
Usage
-----
    python -m phenonn.data_creation.preprocess_features \\
...
from phenonn.data_creation.feature_engineering import add_derived_features
from phenonn.data_creation.grid_utils import make_encoding
...
def parse_args():
    ...
    p.add_argument(
        "--output_dir", required=True, help="Where to write ERA5_features_{Y}.nc"
    )
