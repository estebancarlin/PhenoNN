...
"""Train 36-date annual LAI curves from flat feature and target CSV files.

Each sample is a ``(site_id, year)`` pair. Use ``phenonn train-flat --help``
for options and ``doc/source/data_preparation.rst`` for the exact schema.
"""
